...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-16 md:py-32 px-6 md:px-12 bg-slate-50 dark:bg-black border-t border-gray-200 dark:border-gray-900 relative z-10 scroll-mt-28">
      <div className="max-w-5xl mx-auto text-center">
        <MotionDiv
           ...
           variants={fadeInUp}
        >
            <h2 className="text-3xl md:text-6xl font-bold mb-4 md:mb-6 text-slate-900 dark:text-white tracking-tight">Ready to automate?</h2>
            <p className="text-base md:text-xl text-gray-600 dark:text-gray-400 mb-10 md:mb-16 font-light max-w-2xl mx-auto">
