...
const ServiceCard = ({ icon, title, desc, delay }: { icon: any, title: string, desc: string, delay: number }) => (
  <MotionDiv
    variants={fadeInUp}
    transition={{ delay }}
    className="group p-6 md:p-8 rounded-2xl md:rounded-[2rem] bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 hover:border-blue-500/50 shadow-sm hover:shadow-xl transition-all duration-300 backdrop-blur-sm"
  >
...
const Services = () => {
  ...
  return (
    <section id="services" className="py-16 md:py-32 px-6 md:px-12 relative z-10 scroll-mt-28">
        ...
        >
          <div className="lg:col-span-5">
            <MotionDiv variants={fadeInUp}>
              <span className="text-blue-600 dark:text-blue-500 font-bold tracking-[0.2em] uppercase text-[10px] mb-3 md:mb-4 block">
                Philosophy & Impact
              </span>
              <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6 text-slate-900 dark:text-white tracking-tighter leading-tight font-space">
                What we do
              </h2>
